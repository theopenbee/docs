...
| [Linear](/docs/guide/platforms/linear) | GraphQL polling | Issue tracking integration, label-gated |
...
- **Linear** — Best for engineering teams using Linear for issue tracking. Label-based triggering, no webhook setup needed.
